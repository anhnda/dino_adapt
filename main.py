...
def main(args):
    ...
    if args.eval:
        ...
        print("Infer Adapt: ", args.infer_adapt)
        ...
        print("Stats query:")
        print("Avg all layers: ", model.transformer.decoder.total_layers/ model.transformer.decoder.n_call)
        print("Avg last layer: ", model.transformer.decoder.total_last_layer/ model.transformer.decoder.n_call)


        return

    print("Start training")
    raise RuntimeError("Only for evaluating")
